...
public class PoseVisuallizer3D : MonoBehaviour
{
    ...
    public UnityEvent<Vector3[]> Joints;
    ...
    void LateUpdate(){
        ...
        var joints = new Vector3[detecter.vertexCount];
        ...
        for(int i = 0; i < detecter.vertexCount + 1; i++){
            ...
            */
            ...
            if (i<detecter.vertexCount)
                joints[i] = detecter.GetPoseWorldLandmark(i);
        }
        
        Joints.Invoke(joints);
